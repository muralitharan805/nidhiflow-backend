...
export class PrepaymentDto {
  @ApiProperty({ example: 100000, description: 'Lump-sum principal prepayment amount' })
  @IsNumber()
  @Min(100)
  readonly prepaymentAmount!: number;

  @ApiProperty({ example: 12, description: 'Month index (1-based) at which prepayment is made' })
  @IsNumber()
  @Min(1)
