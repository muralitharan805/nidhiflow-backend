...
export class CreatePostingDto {
  @ApiProperty({
    ...
    description: 'Target account head ID',
  })
  @IsString()
  @IsNotEmpty()
  ...
  @ApiProperty({
    ...
    description: 'DEBIT or CREDIT allocation',
  })
  @IsEnum(PostingType)
  @IsNotEmpty()
  ...
  @ApiProperty({
    example: 1500.5,
    description: 'Monetary transaction amount (must be positive)',
  })
  @IsNumber()
  @Min(0.01)
...
export class CreateJournalEntryDto {
  ...
  @ApiProperty({
    example: 'Monthly grocery purchase at supermarket',
  ...
  @ApiProperty({
    ...
    description:
      'List of posting line allocations (Sum of Debits must equal Sum of Credits)',
  })
  @IsArray()
